      ...
      <div className="container min-height-100vh d-flex align-items-center pt-100 pb-100 pt-sm-120 pb-sm-120">
        ...
        <div className="bg-video-wrapper">
          <video
            ...
            loop
          >
            <source src="/assets/videos/avada-agency-home-reel-1.mp4" type="video/mp4" />
          </video>
        ...
        <div className="home-content">
          <div className="row">
            ...
            <div className="col-md-10 offset-md-1 mb-20 mb-sm-0">
              ...
              Modern Designs. Sustainable Solutions
              </h2>
              <h1 className="hs-title-12 mb-50 mb-sm-30">
                <span className="wow charsAnimIn" data-splitting="chars">
                Crafting bespoke digital experiences that elevate your brand.
                </span>
              </h1>
              <div
